const Exp_prop = (props) => {
  return (
    <>
      <div className="shadow-2xl rounded-3xl border-2 dark:border-white bg-[#e1e1e1] dark:bg-transparent border-[#00040f] h-[490px] max-sm:h-[550px] p-8 hover:bg-gradient-to-tl from-[#e1e1e1] to-[#fff] dark:from-[#00040F] dark:to-[#0B274C]">
